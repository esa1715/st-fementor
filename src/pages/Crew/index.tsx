...
const Crew: React.FC = () => {
  const [selecionado, setSelecionado] = useState<keyof Tripulantes>("hurley");

  const conteudo: Tripulantes = {
    hurley: {
      rank: "COMMANDER",
      name: "DOUGLAS HURLEY",
        ...
        <div className="crew-content">
          <div className="crew-text">
            ...
            <nav className="crew-navbar">
              <ul>
                {(["hurley", "mark", "glover", "ansari"] as (keyof Tripulantes)[]).map((pessoa) => (
                  <li key={pessoa}>
                    <button
                      className={selecionado === pessoa ? "selected" : ""}
